defmodule BlockScoutWeb.Schemas.API.V2.General do
  ...
  @token_type_pattern ~r/^\[?(ERC-20|ERC-721|ERC-1155|ERC-404|LSP7|LSP8)(,(ERC-20|ERC-721|ERC-1155|ERC-404|LSP7|LSP8))*\]?$/i
  ...
  def token_type_param do
    %Parameter{
      ...
      * LSP7 - LUKSO fungible tokens
      * LSP8 - LUKSO non-fungible tokens
